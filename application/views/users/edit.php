                ...
                <div class="m-portlet__body">
                    <div class="m-form__section m-form__section--first">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control m-input" type="text" placeholder="First Name" name='first_name' id='first_name' value='<?php echo $user->first_name;?>' >
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control m-input" type="text" placeholder="Last Name" name='last_name' id='last_name' value='<?php echo $user->last_name;?>' >
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control m-input" type="text" placeholder="Phone" name='phone' id='phone' value='<?php echo $user->phone;?>' >
